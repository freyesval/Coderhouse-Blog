...
def Principal(request):
    return render (request, "Messages/principal.html")

# def EnviarMensaje(request):
#     return render (request, "Messages/EnviarMensaje.html")
...
def BuscarUsuarios(request):
    ...
    return render(request,"Messages/EnviarMensaje.html", {"Usuarios":Usuarios} )


def RedireccionaInbox(request):
